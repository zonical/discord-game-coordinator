...
cmdAdvHelp = {
    ...
    "startqueue": "Creates a queue for people to join.\n(player amount target) = the amount of players the server found should have in total when adding queued players + ingame players\n(provider) = Server provider\n(region) = Server region\n[maps] = Map Filter (defaults to no filter)",
    "join": "Joins an open queue\n(queueid) = the id of the queue listed in the starting message",
